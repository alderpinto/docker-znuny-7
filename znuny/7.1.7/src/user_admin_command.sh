...
function set_admin_user() {
  su -c "/opt/znuny/bin/znuny.Console.pl Admin::User::SetPassword ${ZNUNY_USER_ADMIN_NAME:-$DEFAULT_ZNUNY_USER_ADMIN_NAME} ${ZNUNY_USER_ADMIN_PASSWORD:-$DEFAULT_ZNUNY_USER_ADMIN_PASSWORD}" -s /bin/sh znuny || true
